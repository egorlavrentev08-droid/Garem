...
from core import ADMIN_IDS, is_admin, chat_filter
...
LIBRARY_CHAT_ID = -5363386810  # ID чата-библиотеки

# Маппинг символов на триггеры
TRIGGER_SYMBOLS = {
    '!': '1_DAY_INACTIVE',
...
# Маппинг символов на настроения
MOOD_SYMBOLS = {
    '₽': 'ANXIOUS',
    '£': 'ANGRY',
    '€': 'SARCASTIC',
